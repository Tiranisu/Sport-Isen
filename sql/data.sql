...
INSERT INTO users (id, fistname, lastname, age, email, passwd, city, nb_match, fitness_id, notifications, notifications_list) VALUES
(0, 'Mark', 'Couty', 35, 'mark.couty@test.fr', '1234', 'Sainte-Luce-sur-Loire', 3, 2, 2, {0,1}),
(0, 'Robert', 'Pater', 75, 'robert.pater@test.fr', '1234', 'Carquefou', 28, 2, 1, {0});
